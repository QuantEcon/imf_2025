...
\begin{frame}{Training (Plain Vanilla)}
...
\begin{frame}{Extensions}
    ...
    \begin{itemize}
        \item Variations on SGD  -- momentum terms, etc.
        \vspace{0.5em}
...
\begin{frame}{Alternative story}
    ...
    \begin{itemize}
        ...
        \vspace{0.5em}
        \item Flexible -- universal approximators, can inject inductive bias
        \vspace{0.5em}
...
\begin{frame}
    ...
    Actually we cheated a little bit:

    The call \texttt{θ = θ - λ * loss\_gradient(θ, x\_data, y\_data)} doesn't
    actually work 

    Reason: We are attempting arithmetic operations on lists of tuples of arrays, not arrays

    Because of this we need to modify the code a bit

    We'll do this by using \boldteal{pytrees} --- which can work in many related settings
