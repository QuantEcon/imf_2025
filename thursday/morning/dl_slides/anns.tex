...
\subtitle{Prepared for the IMF Workshop on Computational Economics (Dec 2025)}
...
\begin{frame}{DL with JaX}
    ...
    \begin{itemize}
        \item Both explicitly designed for deep learning
    \end{itemize}

    But DL is the most important use-case
